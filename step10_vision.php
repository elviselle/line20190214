<?php
    ...
    curl_setopt($ch, CURLOPT_HTTPHEADER, array(
        'Authorization: Bearer ROvAyOpIkM7pfd+e7wiwKk1stCMJHFpzE5M5JgKsa7f/YrISMkSb0vAwS66oqI5huJVNNsIFVLR6yiNXzCYxmf9gMt4kQPCl+ZOa+Mf7IjFUfqyEIa5SkzlFeOvPhgPvkzfogF0BLC54cl9XMZ4wMAdB04t89/1O/w1cDnyilFU='
    ));
    ...
    $post_data = array (
        "requests" => array (
            array (
                "image" => array (
                    "source" => array (
                        "imageUri" => "https://159.65.4.103/cht20190214/linebotelvis/".$imageId.".jpeg"
                    )
                ),
                "features" => array (
                    array (
